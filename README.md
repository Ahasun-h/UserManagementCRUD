<h2>UserManagementCRUD</h2>

## About Project
It's a simple Ajax base Laravel CRUD system. Add User with some valid user information, for example, username, email, password, etc. then update and delete that user. Also in getting all registered users on the list.
...
## How to use this project
    ...
    * Set up the database: 
            ...
            => Import the database from the project folder database/db/user_management.sql (Note: After importing the database you can delete the DB folder with db_esellers.sql from the project folder.)
